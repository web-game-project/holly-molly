                    ...
                    <BackGroundDiv>
                        <UserDiv>
                            ...
                            {//let user_list = location.state.data.user_list,
                                ...
                                userList.map(
                                    (index, key) => (
                                        <GameUserCard user_idx={userList[key].user_idx} user_color={userList[key].user_color} user_name={userList[key].user_name} 
                                        user_role="ghost" user_order={userList[key].game_member_order}></GameUserCard>
                                    )
                                )
                            }
                        </UserDiv>
