...
function initModels(sequelize) {
    ...
    WaitingRoomMember.belongsTo(Room, {
        as: 'room_room_idx_Room',
        foreignKey: 'room_room_idx',
    });
    Room.hasMany(WaitingRoomMember, {
        as: 'WaitingRoomMembers',
        foreignKey: 'room_room_idx',
    });
    WaitingRoomMember.belongsTo(User, {
        as: 'user_user_idx_User',
        foreignKey: 'user_user_idx',
    });
    User.hasMany(WaitingRoomMember, {
        as: 'WaitingRoomMembers',
        foreignKey: 'user_user_idx',
    });
    GameMember.belongsTo(WaitingRoomMember, {
        as: 'wrm_wrm_idx_WaitingRoomMember',
        foreignKey: 'wrm_wrm_idx',
    });
    WaitingRoomMember.hasMany(GameMember, {
        as: 'GameMembers',
        foreignKey: 'wrm_wrm_idx',
    });
    GameMember.belongsTo(WaitingRoomMember, {
